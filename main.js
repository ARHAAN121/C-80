...
function submit(){
    ...
    for(var r=0; r < length_of_name_of_student_array;r++)
    {
        display_student_array.push("<h4>NAME- "+name_of_the_student_array[r]+"</h4>");console.log(display_student_array);
    }
...
var length_of_name_of_student_array=name_of_my_friend.length;
    console.log(length_of_name_of_student_array);

    for (var k=0 ; k<length_of_name_of_student_array; k++ )
    {
        display_student_array_sorting.push("<h4>NAME-"+name_of_my_friend[k]+"</h4>");
